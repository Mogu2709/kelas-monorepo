...
const channelMeta = {
  ...
  matkul:     'daftar mata kuliah terdaftar',
  profil:     'profil & pengaturan akun',
  server:     'kelola tampilan & info kelas',
  chat:       'percakapan umum kelas',
};
  ...
  return (
    <div className="topbar">
      <div className="topbar__left">
        <button className="topbar__hamburger" onClick={onMenuClick} aria-label="Buka menu">
          ☰
        </button>
